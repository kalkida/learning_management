...
const CreateNewInventory = ({ open, setOpen }) => {
        ...
        <div className="py-2 px-5">
          ...
          <div className="py-2 px-5">
            ...
            <div className="py-2 px-5">
              ...
              <Input
                ...
                className=" !rounded-lg !border-0 text-[#475467]"
                name="email"
                placeholder="1000"
                onChange={(e) => handleStudent(e)}
              />
          ...
          <div className="py-2 px-5">
              <label>Enter User Name </label>
               <Search placeholder="Enter User Name"  style={{ width: "100%" }}
               enterButton={false}
               className="text-[#98A2B3] text-sm mt-3 !border-[#98A2B3] !bg-[#FFF] !border-radius-[15]"
               />
              {/* <Search
             placeholder="Enter User"
             allowClear
              enterButton={ <Icon  fill={"#98A2B3"} name="search-outline" size="large" 
            style={{ backgroundColor:"#FFF"}}
            />}
              size="large"
              className="text-[#98A2B3] text-sm mt-3 !border-[#98A2B3] !bg-[#FFF]"
            //   onSearch={onSearch}
           /> */}
              {/* <Select
                bordered={true}
                placeholder="Select User Name"
                className="py-6 mt-6 !rounded-lg !border-[#667085] hover:border-[#667085]"
